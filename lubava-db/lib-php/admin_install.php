...
// Create data tables
db_query("CREATE TABLE IF NOT EXISTS $mysql_table (id int(6) NOT NULL auto_increment, class varchar(128) NOT NULL, title varchar(128) NOT NULL, author varchar(128) NOT NULL, sender varchar(64) NOT NULL, year int(4) NOT NULL, uploaded int(4) NOT NULL, pageid int(4) NOT NULL, content longblob NOT NULL, PRIMARY KEY (id)) DEFAULT CHARSET=utf8");
